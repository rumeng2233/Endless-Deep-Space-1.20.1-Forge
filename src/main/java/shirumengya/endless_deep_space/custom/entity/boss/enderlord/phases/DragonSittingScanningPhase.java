...
public class DragonSittingScanningPhase extends AbstractDragonSittingPhase {
   ...
   public DragonSittingScanningPhase(EnderLord p_31342_) {
      super(p_31342_);
   }
   ...
   public void doServerTick() {
      ...
      if (this.dragon.attackTarget != null) {
         if (this.scanningTime > 25) {
            ...
            Vec3 vec3 = (new Vec3(this.dragon.attackTarget.getX() - this.dragon.getX(), 0.0D, this.dragon.attackTarget.getZ() - this.dragon.getZ())).normalize();
            ...
            if (f1 < 0.0F || f1 > 10.0F) {
               double d0 = this.dragon.attackTarget.getX() - this.dragon.head.getX();
               double d1 = this.dragon.attackTarget.getZ() - this.dragon.head.getZ();
         ...
         if (this.dragon.attackTarget != null) {
            this.dragon.getPhaseManager().setPhase(EnderDragonPhase.CHARGING_ENTITY);
            this.dragon.getPhaseManager().getPhase(EnderDragonPhase.CHARGING_ENTITY).setTarget(new Vec3(this.dragon.attackTarget.getX(), this.dragon.attackTarget.getY(), this.dragon.attackTarget.getZ()));
         }
      }
