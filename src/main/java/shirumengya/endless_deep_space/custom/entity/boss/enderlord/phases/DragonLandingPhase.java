...
public class DragonLandingPhase extends AbstractDragonPhaseInstance {
   ...
   public DragonLandingPhase(EnderLord p_31305_) {
      super(p_31305_);
   }
   ...
   public void doServerTick() {
      ...
      if (this.targetLocation == null) {
         this.targetLocation = Vec3.atBottomCenterOf(this.dragon.level().getHeightmapPos(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, this.dragon.getFightOrigin()));
      }
