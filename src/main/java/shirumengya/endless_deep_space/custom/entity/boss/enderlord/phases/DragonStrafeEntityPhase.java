...
public class DragonStrafeEntityPhase extends AbstractDragonPhaseInstance {
   ...
   public DragonStrafeEntityPhase(EnderLord p_31357_) {
      super(p_31357_);
   }

   public void doServerTick() {
      if (this.attackTarget == null) {
         LOGGER.warn("Skipping entity strafe phase because no entity was found");
            ...
            if (this.dragon.hasLineOfSight(this.attackTarget)) {
               ...
               if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                  ...
                  if (this.dragon.getRandom().nextFloat() < 0.5F) {
                  	  AbstractHurtingProjectile dragonfireball = new ClusterFireball(this.dragon.level(), this.dragon, d9, d10, d11);
                  	  AbstractHurtingProjectile dragonfireballOne = new ClusterFireball(this.dragon.level(), this.dragon, d9, d10, d11);
                  	  AbstractHurtingProjectile dragonfireballTwo = new ClusterFireball(this.dragon.level(), this.dragon, d9, d10, d11);
                  	  dragonfireball.moveTo(d6, d7, d8, 0.0F, 0.0F);
                  	  dragonfireballOne.moveTo(d6, d7 - 1.0F, d8, 0.0F, 0.0F);
                  	  dragonfireballTwo.moveTo(d6, d7 - 2.0F, d8, 0.0F, 0.0F);
                  	  this.dragon.level().addFreshEntity(dragonfireball);
                  	  this.dragon.level().addFreshEntity(dragonfireballOne);
                  	  this.dragon.level().addFreshEntity(dragonfireballTwo);
                  } else {
                  	  AbstractHurtingProjectile dragonfireball = new ClusterFireball(this.dragon.level(), this.dragon, d9, d10, d11);
                     if (this.dragon.getRandom().nextFloat() < 0.4F) {
                  	     dragonfireball = new DragonFireball(this.dragon.level(), this.dragon, d9, d10, d11);
                     }
                     dragonfireball.moveTo(d6, d7, d8, 0.0F, 0.0F);
                  	  this.dragon.level().addFreshEntity(dragonfireball);
                  }
   ...
   public EnderDragonPhase<DragonStrafeEntityPhase> getPhase() {
      return EnderDragonPhase.STRAFE_ENTITY;
   }
}