...
@OnlyIn(Dist.CLIENT)
public class ClusterFireballRenderer extends EntityRenderer<ClusterFireball> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("endless_deep_space:textures/entities/enderlord/dragon_fireball.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public ClusterFireballRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(ClusterFireball p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(ClusterFireball p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
   ...
   public ResourceLocation getTextureLocation(ClusterFireball p_114078_) {
