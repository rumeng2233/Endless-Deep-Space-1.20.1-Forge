...
public class ColorfulLightningBoltRenderer extends EntityRenderer<ColorfulLightningBolt> {
   ...
   public ColorfulLightningBoltRenderer(EntityRendererProvider.Context p_174286_) {
      super(p_174286_);
   }
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         for(int k = 0; k < 3; ++k) {
            ...
            for(int j1 = l; j1 >= i1; --j1) {
               ...
               quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, p_115266_.red, p_115266_.green, p_115266_.blue, f10, f11, false, false, true, false);
               quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, p_115266_.red, p_115266_.green, p_115266_.blue, f10, f11, true, false, true, true);
               quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, p_115266_.red, p_115266_.green, p_115266_.blue, f10, f11, true, true, false, true);
               quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, p_115266_.red, p_115266_.green, p_115266_.blue, f10, f11, false, true, false, false);
            }
         }
      }
   ...
   public ResourceLocation getTextureLocation(ColorfulLightningBolt p_115264_) {
