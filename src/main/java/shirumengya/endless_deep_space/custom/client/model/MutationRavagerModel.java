package shirumengya.endless_deep_space.custom.client.model;
...
@OnlyIn(Dist.CLIENT)
public class MutationRavagerModel extends HierarchicalModel<MutationRavager> {
   ...
   public MutationRavagerModel(ModelPart p_170889_) {
      this.root = p_170889_;
   ...
   public void setupAnim(MutationRavager p_103626_, float p_103627_, float p_103628_, float p_103629_, float p_103630_, float p_103631_) {
   ...
   public void prepareMobModel(MutationRavager p_103621_, float p_103622_, float p_103623_, float p_103624_) {
