...
@OnlyIn(Dist.CLIENT)
public class OceanDefenderModel extends HierarchicalModel<OceanDefender> {
   ...
   public OceanDefenderModel(ModelPart p_170600_) {
      this.root = p_170600_;
   ...
   public void setupAnim(OceanDefender p_102719_, float p_102720_, float p_102721_, float p_102722_, float p_102723_, float p_102724_) {
      ...
      if (p_102719_.hasAttackTarget()) {
         entity = p_102719_.getAttackTarget();
      }
