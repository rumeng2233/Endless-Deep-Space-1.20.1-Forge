...
public class JumpStringS2CPacket {
    ...
    public JumpStringS2CPacket(Component string, int time, boolean animateColor, boolean canUpdate) {
    ...
    public JumpStringS2CPacket(FriendlyByteBuf buf) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            JumpStringOverlay.UpdateJumpString(jumpString, jumpTime, animateJumpMessageColor, jumpStringCanUpdate);
        });
        return true;
    }
