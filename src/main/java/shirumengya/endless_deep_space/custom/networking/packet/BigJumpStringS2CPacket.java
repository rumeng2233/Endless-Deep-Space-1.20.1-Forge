...
public class BigJumpStringS2CPacket {
    ...
    public BigJumpStringS2CPacket(Component string, int time, boolean animateColor, boolean canUpdate) {
    ...
    public BigJumpStringS2CPacket(FriendlyByteBuf buf) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            JumpStringOverlay.UpdateBigJumpString(jumpString, jumpTime, animateJumpMessageColor, jumpStringCanUpdate);
        });
        return true;
    }
